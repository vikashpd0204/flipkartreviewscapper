...
def index():
    if request.method == 'POST':
        ...
        try:
            ...
            #table = flipkartPage[searchString] # creating a collection with the same name as search string. Tables and Collections are analogous.
            ...
            for commentbox in commentboxes:
                ...
                try:
                    comtag = commentbox.div.div.find_all('div', {'class': '_2-N8zT'})
